...
const projectsData = {
    'auto-control-app': {
        ...
        image: '<img src="images/projects" alt="Aplicativo de Autocontrole Empresarial">',
        tags: ['Kotlin', 'Android', 'Java', 'SQL'],
        descriptionPt: 
            `<p>Aplicativo para controle empresarial desenvolvido com Kotlin e Java para Android, utilizando banco de dados SQL.</p>
        ...
        descriptionEn: 
            `<p>Business control application developed with Kotlin and Java for Android, using SQL database.</p>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/AutoControlApp' }
        ]
    },
    'task-management': {
        titleKey: 'project-task-management-title',
        image: '<img src="images/projects/task-management.jpg" alt="Sistema de Gerenciamento de Tarefas">',
        tags: ['Java', 'Spring Boot', 'MySQL', 'HTML/CSS/JS', 'CRUD'],
        descriptionPt: 
            `<p>Sistema completo de gerenciamento de tarefas construído com Java (Spring Boot) e MySQL para backend, e HTML, CSS e JavaScript para o frontend.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Complete task management system built with Java (Spring Boot) and MySQL for backend, and HTML, CSS and JavaScript for frontend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/TASK-MANAGEMENT-SYSTEM' }
        ]
    },
    'inventory-management': {
        titleKey: 'project-inventory-management-title',
        image: '<img src="images/projects/inventory-management.jpg" alt="Sistema de Gerenciamento de Inventário">',
        tags: ['Node.js', 'Express.js', 'React.js', 'MySQL', 'bcrypt', 'JWT'],
        descriptionPt: 
            `<p>Sistema de gerenciamento de inventário desenvolvido usando Node.js (Express.js) e MySQL para backend, e React.js para frontend.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Inventory management system developed using Node.js (Express.js) and MySQL for backend, and React.js for frontend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/API-ESTOQUES' }
        ]
    },
    'login-page': {
        ...
        descriptionPt: 
            `<p>Página de login desenvolvida com React.js no frontend e Express.js com SQLite no backend.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Login page developed with React.js on the frontend and Express.js with SQLite on the backend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/PAGINA-LOGIN' }
        ]
    },
    'platform-game': {
        titleKey: 'project-platform-game-title',
        image: '<img src="images/projects/platform-game.jpg" alt="Projeto de Jogo de Plataforma">',
        tags: ['C++', 'SFML', 'OOP', 'UML', 'Game Development'],
        descriptionPt: 
            `<p>Jogo de plataforma 2D desenvolvido em C++ utilizando a biblioteca SFML.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>2D platform game developed in C++ using the SFML library.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/JOGO-PLATAFORMA' }
        ]
    },
    'timecard-app': {
        titleKey: 'project-timecard-app-title',
        image: '<img src="images/projects/timecard-app.jpg" alt="App de Transcrição de Cartão de Ponto">',
        tags: ['Python', 'PDF Processing', 'CSV', 'Data Extraction'],
        descriptionPt: 
            `<p>Aplicativo Python que extrai dados de cartão de ponto em PDFs e converte para formato CSV.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Python application that extracts timecard data from PDFs and converts to CSV format.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/LEITOR-DE-CARTAO-PONTO' }
        ]
    },
    'dashboard-app': {
        titleKey: 'project-dashboard-app-title',
        image: '<img src="images/projects/dashboard-app.jpg" alt="App de Dashboard">',
        tags: ['Python', 'C++', 'GUI', 'Data Visualization'],
        descriptionPt: 
            `<p>Aplicativo de monitoramento de métricas de sistema em tempo real com frontend Python e backend C++.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Real-time system metrics monitoring application with Python frontend and C++ backend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/python-dashboard' }
        ]
    },
    'voting-system': {
        titleKey: 'project-voting-system-title',
        image: '<img src="images/projects/voting-system.jpg" alt="Sistema de Votação">',
        tags: ['Node.js', 'Express.js', 'React.js', 'MySQL', 'RESTful API'],
        descriptionPt: 
            `<p>Sistema de votação online desenvolvido com Node.js (Express) e MySQL para backend, e React.js para frontend.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Online voting system developed with Node.js (Express) and MySQL for backend, and React.js for frontend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/danisommer/PAGINA-ENQUETE' }
        ]
    },
    'video-streaming': {
        titleKey: 'project-video-streaming-title',
        image: '<img src="images/projects/video-streaming.jpg" alt="Site de Streaming de Vídeo">',
        tags: ['Java', 'Spring Boot', 'MongoDB', 'React.js', 'AWS S3'],
        descriptionPt: 
            `<p>Plataforma de streaming de vídeo com backend Java (Spring Boot) e MongoDB, com frontend React.js.</p>
            <p>Recursos incluem:</p>
            <ul>
        ...
        descriptionEn: 
            `<p>Video streaming platform with Java backend (Spring Boot) and MongoDB, with React.js frontend.</p>
            <p>Resources include:</p>
            <ul>
        ...
        links: [
            { icon: 'fab fa-github', textKey: 'project-github', url: 'https://github.com/HunterNicky/TikTube' }
        ]
    }
};
// Theme Toggle
...
const translations = {
    'pt': {
        ...
        'hero-text': 'Estudante de Sistemas de Informação na UTFPR e Estagiário de Desenvolvimento Java na Meisters Solutions, especializado em desenvolvimento de sistemas E-Commerce utilizando Java (Spring), Docker, SQL e Hybris.',
        ...
        'exp-job-li1': 'Especializado em desenvolvimento de sistemas E-Commerce utilizando Java (Spring), Docker, SQL e SAP Hybris no backend, e TypeScript (Spartacus) no frontend.',
        'exp-job-li2': 'Desenvolvimento de integrações com SCPI (SAP Cloud Platform Integration).',
        'exp-job-li3': 'Aprimoramento de habilidades técnicas através de cursos sobre APIs REST, Git e Docker.',
        'exp-job-li4': 'Experiência em trabalho em equipe, comunicação e colaboração com clientes internacionais, melhorando a proficiência em inglês.',
        ...
        'exp-edu-desc': 'Atualmente no 5º semestre do curso de Sistemas de Informação.',
        ...
        'project-dashboard-desc': 'Monitoramento de métricas de sistema em tempo real com uma GUI Python e backend C++.',
        
        'project-platform-game-title': 'Projeto de Jogo de Plataforma',
        'project-platform-game-desc': 'Jogo de plataforma completo em C++ usando SFML, empregando Programação Orientada a Objetos e modelos UML.',
        
        'project-video-streaming-title': 'Site de Streaming de Vídeo',
        'project-video-streaming-desc': 'Contribuição para backend em Java (Spring Boot) com MongoDB, e frontend em React.js.',
        
        'project-task-management-title': 'Sistema de Gerenciamento de Tarefas',
        'project-task-management-desc': 'Sistema de gerenciamento de tarefas construído com Java (Spring Boot) e MySQL para backend, usando HTML, CSS e JavaScript para frontend.',
        
        'project-inventory-title': 'Sistema de Gerenciamento de Inventário',
        'project-inventory-desc': 'Desenvolvido usando Node.js (Express.js) e MySQL para backend, e React.js para frontend. Inclui autenticação com bcrypt e JWT.',
        
        'project-timecard-title': 'App de Transcrição de Cartão de Ponto',
        'project-timecard-desc': 'Desenvolvido em Python para converter dados de cartão de ponto de PDFs para CSV.',
        
        'project-login-title': 'Página de Login',
        'project-login-desc': 'Desenvolvida com React.js no frontend e Express.js com SQLite no backend. Inclui autenticação segura com bcrypt e JWT.',
    ...
    'en': {
        ...
        'hero-title': 'Daniel Zaki Sommer',
        'hero-subtitle': 'Backend Developer',
        'hero-text': 'Information Systems student at UTFPR and Java Development Intern at Meisters Solutions, specialized in E-Commerce systems development using Java (Spring), Docker, SQL, and Hybris.',
        ...
        'exp-job-company': 'Meisters Solutions',
        'exp-job-li1': 'Specialized in E-Commerce systems development using Java (Spring), Docker, SQL, and SAP Hybris on the backend, and TypeScript (Spartacus) on the frontend.',
        'exp-job-li2': 'Development of integrations with SCPI (SAP Cloud Platform Integration).',
        'exp-job-li3': 'Enhancement of technical skills through courses on REST APIs, Git, and Docker.',
        'exp-job-li4': 'Experience in teamwork, communication, and collaboration with international clients, improving English proficiency.',
        ...
        'exp-edu-desc': 'Currently in the 5th semester of Information Systems program.',
        ...
        'project-dashboard-desc': 'Real-time system metrics monitoring with a Python GUI and C++ backend.',
        
        'project-platform-game-title': 'Platform Game Project',
        'project-platform-game-desc': 'Complete platform game in C++ using SFML, employing Object-Oriented Programming and UML models.',
        
        'project-video-streaming-title': 'Video Streaming Website',
        'project-video-streaming-desc': 'Contribution to backend in Java (Spring Boot) with MongoDB, and frontend in React.js.',
        
        'project-task-management-title': 'Task Management System',
        'project-task-management-desc': 'Task management system built with Java (Spring Boot) and MySQL for backend, using HTML, CSS and JavaScript for frontend.',
        
        'project-inventory-title': 'Inventory Management System',
        'project-inventory-desc': 'Developed using Node.js (Express.js) and MySQL for backend, and React.js for frontend. Includes authentication with bcrypt and JWT.',
        
        'project-timecard-title': 'Timecard Transcription App',
        'project-timecard-desc': 'Developed in Python to convert timecard data from PDFs to CSV.',
        
        'project-login-title': 'Login Page',
        'project-login-desc': 'Developed with React.js on the frontend and Express.js with SQLite on the backend. Includes secure authentication with bcrypt and JWT.',
...
function addTranslationAttributes() {
    // Navigation
    document.querySelectorAll('.nav-links a')[0].setAttribute('data-i18n', 'nav-home');
    document.querySelectorAll('.nav-links a')[1].setAttribute('data-i18n', 'nav-about');
    document.querySelectorAll('.nav-links a')[2].setAttribute('data-i18n', 'nav-skills');
    document.querySelectorAll('.nav-links a')[3].setAttribute('data-i18n', 'nav-experience');
    document.querySelectorAll('.nav-links a')[4].setAttribute('data-i18n', 'nav-projects');
    document.querySelectorAll('.nav-links a')[5].setAttribute('data-i18n', 'nav-contact');
    
    // Mobile navigation
    document.querySelectorAll('.mobile-links a')[0].setAttribute('data-i18n', 'nav-home');
    document.querySelectorAll('.mobile-links a')[1].setAttribute('data-i18n', 'nav-about');
    document.querySelectorAll('.mobile-links a')[2].setAttribute('data-i18n', 'nav-skills');
    document.querySelectorAll('.mobile-links a')[3].setAttribute('data-i18n', 'nav-experience');
    document.querySelectorAll('.mobile-links a')[4].setAttribute('data-i18n', 'nav-projects');
    document.querySelectorAll('.mobile-links a')[5].setAttribute('data-i18n', 'nav-contact');
    ...
    document.querySelectorAll('.hero-btns a')[0].setAttribute('data-i18n', 'hero-btn-projects');
    document.querySelectorAll('.hero-btns a')[1].setAttribute('data-i18n', 'hero-btn-contact');
    
    // Section titles
    document.querySelectorAll('.section-title')[0].setAttribute('data-i18n', 'about-title');
    document.querySelectorAll('.section-title')[1].setAttribute('data-i18n', 'skills-title');
    document.querySelectorAll('.section-title')[2].setAttribute('data-i18n', 'experience-title');
    document.querySelectorAll('.section-title')[3].setAttribute('data-i18n', 'projects-title');
    document.querySelectorAll('.section-title')[4].setAttribute('data-i18n', 'contact-title');
    
    // About section
    document.querySelector('.about-content h2').setAttribute('data-i18n', 'about-greeting');
    document.querySelectorAll('.about-content p')[0].setAttribute('data-i18n', 'about-p1');
    document.querySelectorAll('.about-content p')[1].setAttribute('data-i18n', 'about-p2');
    document.querySelector('.about-btn').setAttribute('data-i18n', 'about-btn');
    
    // Skills section
    document.querySelectorAll('.skill-category h3')[0].setAttribute('data-i18n', 'skills-languages');
    document.querySelectorAll('.skill-category h3')[1].setAttribute('data-i18n', 'skills-databases');
    document.querySelectorAll('.skill-category h3')[2].setAttribute('data-i18n', 'skills-languages-heading');
    document.querySelectorAll('.skill-category h3')[3].setAttribute('data-i18n', 'skills-tools');
    
    // Projects section
    document.querySelector('.filter-btn.active').setAttribute('data-i18n', 'projects-btn-all');
    
    // Contact section
    document.querySelector('.contact-info h3').setAttribute('data-i18n', 'contact-info');
    document.querySelector('label[for="name"]').setAttribute('data-i18n', 'contact-form-name');
    document.querySelector('label[for="subject"]').setAttribute('data-i18n', 'contact-form-subject');
    document.querySelector('label[for="message"]').setAttribute('data-i18n', 'contact-form-message');
    document.querySelector('.form-btn').setAttribute('data-i18n', 'contact-form-submit');
    
    // Footer
    document.querySelectorAll('.footer-col h3')[1].setAttribute('data-i18n', 'footer-links');
    document.querySelectorAll('.footer-col h3')[2].setAttribute('data-i18n', 'footer-social');
    document.querySelector('.copyright p').setAttribute('data-i18n', 'footer-copyright');
    
    // Footer links
    document.querySelectorAll('.footer-links a')[0].setAttribute('data-i18n', 'nav-home');
    document.querySelectorAll('.footer-links a')[1].setAttribute('data-i18n', 'nav-about');
    document.querySelectorAll('.footer-links a')[2].setAttribute('data-i18n', 'nav-skills');
    document.querySelectorAll('.footer-links a')[3].setAttribute('data-i18n', 'nav-experience');
    document.querySelectorAll('.footer-links a')[4].setAttribute('data-i18n', 'nav-projects');
    document.querySelectorAll('.footer-links a')[5].setAttribute('data-i18n', 'nav-contact');
    ...
    timelineItems[0].querySelector('h3').setAttribute('data-i18n', 'exp-job-title');
    timelineItems[0].querySelector('.timeline-date').setAttribute('data-i18n', 'exp-job-date');
    timelineItems[0].querySelectorAll('p')[1].setAttribute('data-i18n', 'exp-job-company');
    ...
    timelineItems[1].querySelector('h3').setAttribute('data-i18n', 'exp-edu-title');
    timelineItems[1].querySelector('.timeline-date').setAttribute('data-i18n', 'exp-edu-date');
    timelineItems[1].querySelectorAll('p')[1].setAttribute('data-i18n', 'exp-edu-school');
    timelineItems[1].querySelector('li').setAttribute('data-i18n', 'exp-edu-desc');
    
    // Third timeline item (courses)
    timelineItems[2].querySelector('h3').setAttribute('data-i18n', 'exp-courses-title');
    timelineItems[2].querySelector('.timeline-date').setAttribute('data-i18n', 'exp-courses-date');
    
    // Project filter buttons
    document.querySelectorAll('.filter-btn')[0].setAttribute('data-i18n', 'filter-all');
    document.querySelectorAll('.filter-btn')[1].setAttribute('data-i18n', 'filter-java');
    document.querySelectorAll('.filter-btn')[2].setAttribute('data-i18n', 'filter-kotlin');
    document.querySelectorAll('.filter-btn')[3].setAttribute('data-i18n', 'filter-sql');
    document.querySelectorAll('.filter-btn')[4].setAttribute('data-i18n', 'filter-python');
    document.querySelectorAll('.filter-btn')[5].setAttribute('data-i18n', 'filter-js');
    document.querySelectorAll('.filter-btn')[6].setAttribute('data-i18n', 'filter-cpp');
    
    // Project cards - Add translation attributes to individual project cards
    const projectCards = document.querySelectorAll('.project-card');
    
    // Auto Control App
    projectCards[0].querySelector('.project-title').lastChild.textContent = ' Aplicativo de Autocontrole Empresarial';
    projectCards[0].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-auto-control-title');
    projectCards[0].querySelector('.project-desc').setAttribute('data-i18n', 'project-auto-control-desc');
    projectCards[0].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[0].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Dashboard App
    projectCards[1].querySelector('.project-title').lastChild.textContent = ' App de Dashboard';
    projectCards[1].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-dashboard-title');
    projectCards[1].querySelector('.project-desc').setAttribute('data-i18n', 'project-dashboard-desc');
    projectCards[1].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[1].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Platform Game
    projectCards[2].querySelector('.project-title').lastChild.textContent = ' Projeto de Jogo de Plataforma';
    projectCards[2].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-platform-game-title');
    projectCards[2].querySelector('.project-desc').setAttribute('data-i18n', 'project-platform-game-desc');
    projectCards[2].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[2].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Video Streaming
    projectCards[3].querySelector('.project-title').lastChild.textContent = ' Site de Streaming de Vídeo';
    projectCards[3].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-video-streaming-title');
    projectCards[3].querySelector('.project-desc').setAttribute('data-i18n', 'project-video-streaming-desc');
    projectCards[3].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[3].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Task Management
    projectCards[4].querySelector('.project-title').lastChild.textContent = ' Sistema de Gerenciamento de Tarefas';
    projectCards[4].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-task-management-title');
    projectCards[4].querySelector('.project-desc').setAttribute('data-i18n', 'project-task-management-desc');
    projectCards[4].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[4].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Inventory Management
    projectCards[5].querySelector('.project-title').lastChild.textContent = ' Sistema de Gerenciamento de Inventário';
    projectCards[5].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-inventory-title');
    projectCards[5].querySelector('.project-desc').setAttribute('data-i18n', 'project-inventory-desc');
    projectCards[5].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[5].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Timecard App
    projectCards[6].querySelector('.project-title').lastChild.textContent = ' App de Transcrição de Cartão de Ponto';
    projectCards[6].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-timecard-title');
    projectCards[6].querySelector('.project-desc').setAttribute('data-i18n', 'project-timecard-desc');
    projectCards[6].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[6].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Login Page
    projectCards[7].querySelector('.project-title').lastChild.textContent = ' Página de Login';
    projectCards[7].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-login-title');
    projectCards[7].querySelector('.project-desc').setAttribute('data-i18n', 'project-login-desc');
    projectCards[7].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[7].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
    
    // Voting System
    projectCards[8].querySelector('.project-title').lastChild.textContent = ' Sistema de Votação';
    projectCards[8].querySelector('.project-title').lastChild.setAttribute('data-i18n', 'project-voting-title');
    projectCards[8].querySelector('.project-desc').setAttribute('data-i18n', 'project-voting-desc');
    projectCards[8].querySelectorAll('.project-link span')[0].setAttribute('data-i18n', 'project-details');
    projectCards[8].querySelectorAll('.project-link span')[1].setAttribute('data-i18n', 'project-github');
}

// Contact Form Submission - Update alert message
contactForm.addEventListener('submit', (e) => {
    e.preventDefault();
